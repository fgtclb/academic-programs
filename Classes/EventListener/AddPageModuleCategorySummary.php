 ...
 * of this extension, of `EXT:academic_projects` and of `EXT:academic_partners`. All this
 * listener contributes are the two constants that make it a program summary: the page type and
 * the category group.
 *
 ...
 */
#[AsEventListener(identifier: 'academic-programs/page-module-category-summary')]
