...
final class ProgramListRouteEnhancerTest extends AbstractAcademicProgramsTestCase
{
    ...
    private function loadShippedRouteEnhancers(): array
    {
        ...
        // reachable the same way on both supported core versions: the functional
        // test container of v12 does not publish it, and its constructor takes no
        // logger there while v13 requires one. The point of this test is that the
        // shipped file itself is loaded, not which reader loads it.
